            ...
            <div class="stats-grid">
                ...
                <div class="stat-card stat-green">
                    ...
                    <div>
                        ...
                        <span class="stat-label">${i18n.t('student')}</span>
                    </div>
                </div>
                <div class="stat-card stat-purple">
                    <i class="ph ph-chalkboard-teacher"></i>
                    <div>
                        <span class="stat-num">${teachers.length}</span>
                        <span class="stat-label">${i18n.t('teacher')}</span>
                    </div>
                </div>
...
AdminPage.init = () => {
    ...
    document.getElementById('super-section-switch')?.addEventListener('change', (e) => {
    ...
    document.getElementById('add-announcement-btn')?.addEventListener('click', async () => {
        ...
        `, async () => {
            ...
            const sid = document.getElementById('ann-section')?.value;
            const targetDate = document.getElementById('ann-target-date')?.value;
    ...
    document.getElementById('add-subject-btn')?.addEventListener('click', async () => {
        ...
        `, async () => {
            ...
            await api.addSubject({
                ...
                section_id: document.getElementById('s-section')?.value
            });
            return true;
        });
        if (result) location.reload();
    ...
    document.getElementById('add-any-user-btn')?.addEventListener('click', async () => {
        const sections = await api.getSections();
